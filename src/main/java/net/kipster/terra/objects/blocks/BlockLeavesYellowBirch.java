...
public class BlockLeavesYellowBirch extends BlockLeaves implements IHasModel
{
	public BlockLeavesYellowBirch(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.YELLOWBIRCHSAPLING);
    }
