...
public class BlockLeavesMangrove extends BlockLeaves implements IHasModel
{
	public BlockLeavesMangrove(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.MANGROVESAPLING);
    }
