...
public class BlockKamboradoiteOre extends Block implements IHasModel
{
	public BlockKamboradoiteOre(String name, Material material) 
	{
		super(Material.ROCK);
