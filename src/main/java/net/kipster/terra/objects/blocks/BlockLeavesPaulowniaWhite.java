...
public class BlockLeavesPaulowniaWhite extends BlockLeaves implements IHasModel
{
	public BlockLeavesPaulowniaWhite(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.PAULOWNIASAPLINGWHITE);
    }
