...
public class BlockBlueSchist extends Block implements IHasModel
{
	public BlockBlueSchist(String name, Material material) 
	{
		super(Material.ROCK);
	 ...
	 public Item getItemDropped(IBlockState state, Random rand, int fortune)

	     {
	         ...
	         return Item.getItemFromBlock(BlockInit.BLUESCHIST_COBBLESTONE);
