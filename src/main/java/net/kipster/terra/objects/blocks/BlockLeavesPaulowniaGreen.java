...
public class BlockLeavesPaulowniaGreen extends BlockLeaves implements IHasModel
{
	public BlockLeavesPaulowniaGreen(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.PAULOWNIASAPLINGGREEN);
    }
