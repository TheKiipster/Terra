...
public class BlockLeavesJacarandaPurple extends BlockLeaves implements IHasModel
{
	public BlockLeavesJacarandaPurple(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.JACARANDASAPLINGPURPLE);
    }
