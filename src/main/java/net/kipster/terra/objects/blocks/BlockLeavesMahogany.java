...
public class BlockLeavesMahogany extends BlockLeaves implements IHasModel
{
	public BlockLeavesMahogany(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.MAHOGANYSAPLING);
    }
