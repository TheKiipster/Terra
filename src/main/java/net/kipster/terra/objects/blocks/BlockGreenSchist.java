...
public class BlockGreenSchist extends Block implements IHasModel
{
	public BlockGreenSchist(String name, Material material) 
	{
		super(Material.ROCK);
	 ...
	 public Item getItemDropped(IBlockState state, Random rand, int fortune)

	     {
	         ...
	         return Item.getItemFromBlock(BlockInit.GREENSCHIST_COBBLESTONE);
