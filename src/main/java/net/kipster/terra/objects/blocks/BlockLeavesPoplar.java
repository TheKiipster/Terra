...
public class BlockLeavesPoplar extends BlockLeaves implements IHasModel
{
	public BlockLeavesPoplar(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.POPLARSAPLING);
    }
