...
public class BlockMigmatite extends Block implements IHasModel
{
	public BlockMigmatite(String name, Material material) 
	{
		super(Material.ROCK);
	 ...
	 public Item getItemDropped(IBlockState state, Random rand, int fortune)

	     {
	         ...
	         return Item.getItemFromBlock(BlockInit.MIGMATITE_COBBLESTONE);
