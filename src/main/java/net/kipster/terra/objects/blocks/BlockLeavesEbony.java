...
public class BlockLeavesEbony extends BlockLeaves implements IHasModel
{
	public BlockLeavesEbony(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.EBONYSAPLING);
    }
