...
public class BlockLeavesPalm extends BlockLeaves implements IHasModel
{
	public BlockLeavesPalm(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.PALMSAPLING);
    }
