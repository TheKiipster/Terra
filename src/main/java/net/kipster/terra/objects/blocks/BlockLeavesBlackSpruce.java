...
public class BlockLeavesBlackSpruce extends BlockLeaves implements IHasModel
{
	public BlockLeavesBlackSpruce(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.BLACKSPRUCESAPLING);
    }
