...
public class BlockSoapstone extends Block implements IHasModel
{
	public BlockSoapstone(String name, Material material) 
	{
		super(Material.ROCK);
	 ...
	 public Item getItemDropped(IBlockState state, Random rand, int fortune)

	     {
	         ...
	         return Item.getItemFromBlock(BlockInit.SOAPSTONE_COBBLESTONE);
