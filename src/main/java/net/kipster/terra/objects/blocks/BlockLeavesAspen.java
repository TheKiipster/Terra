...
public class BlockLeavesAspen extends BlockLeaves implements IHasModel
{
	public BlockLeavesAspen(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.ASPENSAPLING);
    }
