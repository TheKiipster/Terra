...
public class BlockLeavesJacarandaMagenta extends BlockLeaves implements IHasModel
{
	public BlockLeavesJacarandaMagenta(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.JACARANDASAPLINGMAGENTA);
    }
