...
public class BlockLeavesPaulowniaBlue extends BlockLeaves implements IHasModel
{
	public BlockLeavesPaulowniaBlue(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.PAULOWNIASAPLINGBLUE);
    }
