...
public class BlockRedQuartzite extends Block implements IHasModel
{
	public BlockRedQuartzite(String name, Material material) 
	{
		super(Material.ROCK);
	 ...
	 public Item getItemDropped(IBlockState state, Random rand, int fortune)

	     {
	         ...
	         return Item.getItemFromBlock(BlockInit.REDQUARTZITE_COBBLESTONE);
