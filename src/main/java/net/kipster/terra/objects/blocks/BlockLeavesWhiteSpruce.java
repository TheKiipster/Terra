...
public class BlockLeavesWhiteSpruce extends BlockLeaves implements IHasModel
{
	public BlockLeavesWhiteSpruce(String name, Material material) 
	{
    ...
    {
        return Item.getItemFromBlock(BlockInit.WHITESPRUCESAPLING);
    }
