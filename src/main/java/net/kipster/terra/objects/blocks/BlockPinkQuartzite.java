...
public class BlockPinkQuartzite extends Block implements IHasModel
{
	public BlockPinkQuartzite(String name, Material material) 
	{
		super(Material.ROCK);
	 ...
	 public Item getItemDropped(IBlockState state, Random rand, int fortune)

	     {
	         ...
	         return Item.getItemFromBlock(BlockInit.PINKQUARTZITE_COBBLESTONE);
