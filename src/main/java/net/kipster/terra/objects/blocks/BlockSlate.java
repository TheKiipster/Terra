...
public class BlockSlate extends Block implements IHasModel
{
	public BlockSlate(String name, Material material) 
	{
		super(Material.ROCK);
	 ...
	 public Item getItemDropped(IBlockState state, Random rand, int fortune)

	     {
	         ...
	         return Item.getItemFromBlock(BlockInit.SLATE_COBBLESTONE);
