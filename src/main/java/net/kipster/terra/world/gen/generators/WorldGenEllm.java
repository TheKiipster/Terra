...
public class WorldGenEllm extends WorldGenAbstractTree
{
    private static final IBlockState LOG = BlockInit.ELMLOG.getDefaultState();
    private static final IBlockState LEAF = BlockInit.ELMLEAVES.getDefaultState();
    private final boolean useExtraRandomHeight;

    public WorldGenEllm(boolean notify, boolean useExtraRandomHeightIn)
    {
        super(notify);
