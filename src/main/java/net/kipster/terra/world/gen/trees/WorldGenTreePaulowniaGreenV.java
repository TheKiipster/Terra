...
public class WorldGenTreePaulowniaGreenV extends WorldGenAbstractTree
{
	public static final IBlockState TRUNK = BlockInit.PAULOWNIALOG.getDefaultState();
	public static final IBlockState LEAF = BlockInit.PAULOWNIALEAVESGREEN.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));

    public WorldGenTreePaulowniaGreenV()
    {
        super(false);
    }
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        for (i = rand.nextInt(4) + 8; worldIn.getBlockState(position.down()).getMaterial() == Material.WATER; position = position.down())
        {
            ;
        }
