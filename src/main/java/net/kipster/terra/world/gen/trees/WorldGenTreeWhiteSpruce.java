...
public class WorldGenTreeWhiteSpruce extends WorldGenAbstractTree
{
    private static final IBlockState TRUNK = BlockInit.WHITESPRUCELOG.getDefaultState();
    public static final IBlockState LEAF = BlockInit.WHITESPRUCELEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));

    public WorldGenTreeWhiteSpruce(boolean p_i2025_1_)
    {
        super(p_i2025_1_);
    }
