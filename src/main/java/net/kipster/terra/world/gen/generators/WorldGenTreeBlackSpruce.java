...
public class WorldGenTreeBlackSpruce extends WorldGenAbstractTree
{
    private static final IBlockState TRUNK = BlockInit.BLACKSPRUCELOG.getDefaultState();
    public static final IBlockState LEAF = BlockInit.BLACKSPRUCELEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));

    public WorldGenTreeBlackSpruce(boolean p_i2025_1_)
    {
        super(p_i2025_1_);
    }
