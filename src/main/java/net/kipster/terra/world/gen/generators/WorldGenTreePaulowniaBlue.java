...
public class WorldGenTreePaulowniaBlue extends WorldGenAbstractTree
{
	public static final IBlockState LOG = BlockInit.PAULOWNIALOG.getDefaultState();
	public static final IBlockState LEAF = BlockInit.PAULOWNIALEAVESBLUE.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
    private final boolean useExtraRandomHeight;

    public WorldGenTreePaulowniaBlue(boolean notify, boolean useExtraRandomHeightIn)
    {
        super(notify);
