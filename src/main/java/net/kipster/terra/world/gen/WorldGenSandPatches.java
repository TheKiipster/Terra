...
public class WorldGenSandPatches extends WorldGenerator {
    private final IBlockState state;
    private final int size;
    private List<Block> replaceableBlocks = new ArrayList<>();

    public WorldGenSandPatches(IBlockState state, int size, Block... replaceableBlocks) {
        this.state = state;
        this.size = size;
    ...
    public WorldGenSandPatches(IBlockState state, int size) {
        this(state, size, Blocks.DIRT, Blocks.GRASS, Blocks.STONE, Blocks.SAND);
    }
