...
public class WorldGenTreeRedSpruce extends WorldGenAbstractTree
{
    private static final IBlockState TRUNK = BlockInit.REDSPRUCELOG.getDefaultState();
    public static final IBlockState LEAF = BlockInit.REDSPRUCELEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));

    public WorldGenTreeRedSpruce(boolean p_i2025_1_)
    {
        super(p_i2025_1_);
    }
