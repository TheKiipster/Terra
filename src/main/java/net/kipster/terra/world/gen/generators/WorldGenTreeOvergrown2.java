...
public class WorldGenTreeOvergrown2 extends WorldGenAbstractTree
{
    ...
    private static final IBlockState LEAF = Blocks.LEAVES.getDefaultState().withProperty(BlockOldLeaf.VARIANT, BlockPlanks.EnumType.JUNGLE).withProperty(BlockOldLeaf.CHECK_DECAY, Boolean.valueOf(false));

    public WorldGenTreeOvergrown2()
    {
        super(false);
    }
