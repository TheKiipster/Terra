...
public class WorldGenTallPineTest extends WorldGenHugeTrees
{
	 private static final IBlockState TRUNK = Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.SPRUCE);
	    ...
	    public WorldGenTallPineTest(boolean notify, boolean p_i45457_2_)
	    {
	        super(notify, 20, 25, TRUNK, LEAF);
	    ...
	    {
	        int i = rand.nextInt(7) + (this.useBaseHeight ? this.baseHeight : 5);
	        int j = 0;
