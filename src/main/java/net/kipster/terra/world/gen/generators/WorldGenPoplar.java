...
{
	public static final IBlockState LOG = BlockInit.POPLARLOG.getDefaultState();
	public static final IBlockState LEAF = BlockInit.POPLARLEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
    private final boolean useExtraRandomHeight;

    public WorldGenPoplar(boolean notify, boolean useExtraRandomHeightIn)
    {
        super(notify);
