...
{
	public static final IBlockState LOG = BlockInit.ASPENLOG.getDefaultState();
	public static final IBlockState LEAF = BlockInit.ASPENLEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
    private final boolean useExtraRandomHeight;

    public WorldGenAspen(boolean notify, boolean useExtraRandomHeightIn)
    {
        super(notify);
