...
{
    private static final IBlockState TRUNK = BlockInit.MANGROVELOG.getDefaultState();
    private static final IBlockState LEAF = BlockInit.MANGROVELEAVES.getDefaultState();
