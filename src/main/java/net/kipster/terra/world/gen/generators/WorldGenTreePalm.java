...
{
    private static final IBlockState TRUNK = BlockInit.PALMLOG.getDefaultState();
    private static final IBlockState LEAF = BlockInit.PALMLEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));

    public WorldGenTreePalm(boolean doBlockNotify)
    {
        super(doBlockNotify);
    }
    ...
    {
        int i = rand.nextInt(3) + rand.nextInt(3) + 7;
        boolean flag = true;
