...
public class WorldGenTreeJacarandaPurple extends WorldGenAbstractTree
{
	public static final IBlockState LOG = BlockInit.JACARANDALOG.getDefaultState();
	public static final IBlockState LEAF = BlockInit.JACARANDALEAVESPURPLE.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
    private final boolean useExtraRandomHeight;

    public WorldGenTreeJacarandaPurple(boolean notify, boolean useExtraRandomHeightIn)
    {
        super(notify);
