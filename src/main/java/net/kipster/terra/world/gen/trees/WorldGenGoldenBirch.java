...
public class WorldGenGoldenBirch extends WorldGenAbstractTree
{
    ...
    private static final IBlockState LEAF = BlockInit.YELLOWBIRCHLEAVES.getDefaultState();
    private final boolean useExtraRandomHeight;

    public WorldGenGoldenBirch(boolean notify, boolean useExtraRandomHeightIn)
    {
        super(notify);
