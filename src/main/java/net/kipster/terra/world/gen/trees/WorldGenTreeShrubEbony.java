...
public class WorldGenTreeShrubEbony extends WorldGenTrees
{
    private final IBlockState leavesMetadata;
    private final IBlockState woodMetadata;

    public WorldGenTreeShrubEbony()
    {
        super(false);
        this.woodMetadata = BlockInit.EBONYLOG.getDefaultState();
        this.leavesMetadata = BlockInit.EBONYLEAVES.getDefaultState();
    }
