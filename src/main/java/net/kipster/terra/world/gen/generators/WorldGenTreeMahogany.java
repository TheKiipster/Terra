...
public class WorldGenTreeMahogany extends WorldGenHugeTrees
{
	 private static final IBlockState TRUNK = BlockInit.MAHOGANYLOG.getDefaultState();
	    private static final IBlockState LEAF = BlockInit.MAHOGANYLEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
    public WorldGenTreeMahogany(boolean notify, boolean p_i45457_2_)
    {
        super(notify, 15, 15, TRUNK, LEAF);
    }
