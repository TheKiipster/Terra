...
public class WorldGenCrimson extends WorldGenAbstractTree
{
    ...
    private static final IBlockState LEAF = Blocks.LEAVES.getDefaultState().withProperty(BlockOldLeaf.VARIANT, BlockPlanks.EnumType.OAK);
    private final boolean useExtraRandomHeight;

    public WorldGenCrimson(boolean notify, boolean useExtraRandomHeightIn)
    {
        super(notify);
