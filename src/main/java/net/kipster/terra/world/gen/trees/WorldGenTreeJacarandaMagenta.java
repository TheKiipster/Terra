...
public class WorldGenTreeJacarandaMagenta extends WorldGenAbstractTree
{
	public static final IBlockState LOG = BlockInit.JACARANDALOG.getDefaultState();
	public static final IBlockState LEAF = BlockInit.JACARANDALEAVESMAGENTA.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
    private final boolean useExtraRandomHeight;

    public WorldGenTreeJacarandaMagenta(boolean notify, boolean useExtraRandomHeightIn)
    {
        super(notify);
