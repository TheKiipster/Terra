...
public class WorldGenTreeCherryPurple extends WorldGenAbstractTree
{
    ...
    List<WorldGenTreeCherryPurple.FoliageCoordinates> foliageCoords;

    public WorldGenTreeCherryPurple(boolean notify)
    {
        super(notify);
    }
    ...
    void generateLeafNodeList()
    {
        ...
        this.foliageCoords = Lists.<WorldGenTreeCherryPurple.FoliageCoordinates>newArrayList();
        this.foliageCoords.add(new WorldGenTreeCherryPurple.FoliageCoordinates(this.basePos.up(k), j));
            ...
            if (f >= 0.0F)
            {
                for (int l = 0; l < i; ++l)
                {
                    ...
                    if (this.checkBlockLine(blockpos, blockpos1) == -1)
                    {
                        ...
                        {
                            this.foliageCoords.add(new WorldGenTreeCherryPurple.FoliageCoordinates(blockpos, blockpos2.getY()));
                        }
                    }
                }
            }
    ...
    void generateLeaves()
    {
        for (WorldGenTreeCherryPurple.FoliageCoordinates worldgenbigtree$foliagecoordinates : this.foliageCoords)
        {
