...
public class BiomePinkBeach extends BiomeBeach{	
	
	public BiomePinkBeach() 
	{
		
		super(new BiomeProperties("Pink Beach").setBaseHeight(-0.45F).setHeightVariation(0.017F).setTemperature(0.8F).setRainfall(0.4F));
