...
public class Shores extends GenLayer
{

	public Shores(long p_i2130_1_, GenLayer p_i2130_3_) 
	{
		super(p_i2130_1_);
    ...
    public int[] getInts(int areaX, int areaY, int areaWidth, int areaHeight)
    {
        ...
        for (int i = 0; i < areaHeight; ++i)
        {
            for (int j = 0; j < areaWidth; ++j)
            {
                ...
                if (k == Biome.getIdForBiome(BiomeInit.WHITEDESERT))
                {
                    ...
                    {
                        aint1[j + i * areaWidth] = Biome.getIdForBiome(BiomeInit.PINKBEACH);
                    }
                }
