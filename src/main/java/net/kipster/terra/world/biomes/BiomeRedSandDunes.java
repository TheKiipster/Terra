...
{	
	...
	public BiomeRedSandDunes() 
	{
		...
		super(new BiomeProperties("Red Sand Dunes").setBaseHeight(0F).setHeightVariation(0.5F).setTemperature(Biomes.DESERT.getDefaultTemperature()).setRainfall(Biomes.DESERT.getRainfall()).setRainDisabled());
