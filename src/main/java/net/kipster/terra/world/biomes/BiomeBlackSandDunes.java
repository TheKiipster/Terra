...
public class BiomeBlackSandDunes extends Biome
{
	...
	public BiomeBlackSandDunes() 
	{
		super(new BiomeProperties("Black Sand Dunes").setBaseHeight(0F).setHeightVariation(0.5F).setTemperature(Biomes.DESERT.getDefaultTemperature()).setRainfall(Biomes.DESERT.getRainfall()).setRainDisabled());
		
		BiomeManager.addVillageBiome(BiomeInit.BLACKSAND_DUNES , true);
