...
{	
	...
	public BiomeColdBlueTaiga() 
	{
		
		super(new BiomeProperties("Cold Blue Taiga").setBaseHeight(Biomes.COLD_TAIGA.getBaseHeight()).setHeightVariation(Biomes.COLD_TAIGA.getHeightVariation()).setTemperature(Biomes.COLD_TAIGA.getDefaultTemperature()).setRainfall(Biomes.COLD_TAIGA.getRainfall()));
