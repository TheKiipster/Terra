...
{	
	...
	{
		super(new BiomeProperties("Blossom Archipelago").setBaseHeight(-1.8F).setHeightVariation(0.85F).setRainfall(Biomes.FOREST.getRainfall()).setTemperature(Biomes.FOREST.getDefaultTemperature()));
		
		BiomeManager.addVillageBiome(BiomeInit.BLOSSOM_ARCHIPELAGO , false);
