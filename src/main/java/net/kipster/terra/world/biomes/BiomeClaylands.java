...
public class BiomeClaylands extends Biome
{
	...
	protected static final WorldGenWeirdLineThing CLAY = new WorldGenWeirdLineThing(Blocks.HARDENED_CLAY, 1);
	...
	public BiomeClaylands() 
	{
		...
		super(new BiomeProperties("Claylands").setBaseHeight(0.84F).setHeightVariation(0.5F).setTemperature(0.8F).setRainfall(0.4F));
		
		BiomeManager.addVillageBiome(BiomeInit.CLAYLANDS , true);
