...
public class BiomeOrangeSandDunes extends Biome 
{	
	protected static final WorldGenLakes LAVA_LAKE_FEATURE = new WorldGenLakes(Blocks.LAVA);
	
	public BiomeOrangeSandDunes() 
	{
		
		super(new BiomeProperties("Orange Sand Dunes").setBaseHeight(0F).setHeightVariation(0.5F).setTemperature(Biomes.DESERT.getDefaultTemperature()).setRainfall(Biomes.DESERT.getRainfall()).setRainDisabled());
