...
import net.kipster.terra.world.gen.generators.WorldGenAspen;
import net.kipster.terra.world.gen.generators.WorldGenGoldenBirch;
...
{	
	...
	public BiomeGoldenForest() 
	{
		...
		super(new BiomeProperties("Golden Forest").setBaseHeight(Biomes.FOREST.getBaseHeight()).setHeightVariation(Biomes.FOREST.getHeightVariation()).setTemperature(Biomes.FOREST.getDefaultTemperature()).setRainfall(Biomes.FOREST.getRainfall()));
		
		BiomeManager.addVillageBiome(BiomeInit.GOLDEN_FOREST , true);
 ...
 public BlockFlower.EnumFlowerType pickRandomFlower(Random rand, BlockPos pos)
	...
	public WorldGenAbstractTree getRandomTreeFeature(Random rand) 
	{
		...
		{
		  return (WorldGenAbstractTree)(rand.nextInt(3) == 0 ? TREE2 : TREE2);
		}
	}
