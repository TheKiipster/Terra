...
public class BiomeTropicalDesert extends Biome
{
	...
	public BiomeTropicalDesert() 
	{
		super(new BiomeProperties("Tropical Desert").setBaseHeight(0.125F).setHeightVariation(0.05F).setTemperature(0.95F).setRainfall(0.9F).setWaterColor(0x63d4ff));
		
		BiomeManager.addVillageBiome(BiomeInit.TROPICAL_DESERT , true);
