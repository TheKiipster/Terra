...
public class BiomeJungleArchipelago extends Biome 
{	
	...
	{
		super(new BiomeProperties("Jungle Archipelago").setBaseHeight(-0.55F).setHeightVariation(0.75F).setTemperature(0.95F).setRainfall(0.9F));
