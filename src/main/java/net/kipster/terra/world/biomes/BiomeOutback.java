...
import net.kipster.terra.world.gen.trees.WorldGenTreeShrubAcacia;
...
public class BiomeOutback extends Biome
{
	 ...
	 protected static final WorldGenSandPatches GRASS = new WorldGenSandPatches(Blocks.GRASS.getDefaultState(), 4);
	protected static final WorldGenAbstractTree SHRUB_ACACIA = new WorldGenTreeShrubAcacia();
	
	public BiomeOutback() 
	{
		super(new BiomeProperties("Outback").setBaseHeight(0.120F).setHeightVariation(0.06F).setTemperature(1.9F).setRainfall(0F));
	...
	//	topBlock = Blocks.GRASS.getDefaultState();
        ...
        this.decorator.cactiPerChunk = 8;
...
{
	return (WorldGenAbstractTree)(rand.nextInt(2) == 0 ? SHRUB_ACACIA : SHRUB_ACACIA);
	}
@Override
