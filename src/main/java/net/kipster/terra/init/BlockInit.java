...
public class BlockInit
{
	...
	//Cobblestone
	public static final Block BASALT_COBBLESTONE = new BlockNewRocks("basalt_cobblestone", Material.ROCK);
	public static final Block BLACKDIORITE_COBBLESTONE = new BlockNewRocks("blackdiorite_cobblestone", Material.ROCK);
	public static final Block IMPERIALQUARTZITE_COBBLESTONE = new BlockNewRocks("imperialquartzite_cobblestone", Material.ROCK);
	public static final Block PINKQUARTZITE_COBBLESTONE = new BlockNewRocks("pinkquartzite_cobblestone", Material.ROCK);
	public static final Block REDQUARTZITE_COBBLESTONE = new BlockNewRocks("redquartzite_cobblestone", Material.ROCK);
	public static final Block CHALK_COBBLESTONE = new BlockNewRocks("chalk_cobblestone", Material.ROCK);
	public static final Block BLUESCHIST_COBBLESTONE = new BlockNewRocks("blueschist_cobblestone", Material.ROCK);
	public static final Block GREENSCHIST_COBBLESTONE = new BlockNewRocks("greenschist_cobblestone", Material.ROCK);
	public static final Block GABBRO_COBBLESTONE = new BlockNewRocks("gabbro_cobblestone", Material.ROCK);
	public static final Block GNEISS_COBBLESTONE = new BlockNewRocks("gneiss_cobblestone", Material.ROCK);
	public static final Block KIMBERLITE_COBBLESTONE = new BlockNewRocks("kimberlite_cobblestone", Material.ROCK);
	public static final Block LIMESTONE_COBBLESTONE = new BlockNewRocks("limestone_cobblestone", Material.ROCK);
	public static final Block MARBLE_COBBLESTONE = new BlockNewRocks("marble_cobblestone", Material.ROCK);
	public static final Block MIGMATITE_COBBLESTONE = new BlockNewRocks("migmatite_cobblestone", Material.ROCK);
	public static final Block PUMICE_COBBLESTONE = new BlockNewRocks("pumice_cobblestone", Material.ROCK);
	public static final Block RHYOLITE_COBBLESTONE = new BlockNewRocks("rhyolite_cobblestone", Material.ROCK);
	public static final Block SCORIA_COBBLESTONE = new BlockNewRocks("scoria_cobblestone", Material.ROCK);
	public static final Block SLATE_COBBLESTONE = new BlockNewRocks("slate_cobblestone", Material.ROCK);
	public static final Block SOAPSTONE_COBBLESTONE = new BlockNewRocks("soapstone_cobblestone", Material.ROCK);
	
	//Stone Brick
	public static final Block BASALT_STONEBRICK = new BlockNewRocks("basalt_stonebrick", Material.ROCK);
	public static final Block BLACKDIORITE_STONEBRICK = new BlockNewRocks("blackdiorite_stonebrick", Material.ROCK);
	public static final Block IMPERIALQUARTZITE_STONEBRICK = new BlockNewRocks("imperialquartzite_stonebrick", Material.ROCK);
	public static final Block PINKQUARTZITE_STONEBRICK = new BlockNewRocks("pinkquartzite_stonebrick", Material.ROCK);
	public static final Block REDQUARTZITE_STONEBRICK = new BlockNewRocks("redquartzite_stonebrick", Material.ROCK);
	public static final Block CHALK_STONEBRICK = new BlockNewRocks("chalk_stonebrick", Material.ROCK);
	public static final Block BLUESCHIST_STONEBRICK = new BlockNewRocks("blueschist_stonebrick", Material.ROCK);
	public static final Block GREENSCHIST_STONEBRICK = new BlockNewRocks("greenschist_stonebrick", Material.ROCK);
	public static final Block GABBRO_STONEBRICK = new BlockNewRocks("gabbro_stonebrick", Material.ROCK);
	public static final Block GNEISS_STONEBRICK = new BlockNewRocks("gneiss_stonebrick", Material.ROCK);
	public static final Block KIMBERLITE_STONEBRICK = new BlockNewRocks("kimberlite_stonebrick", Material.ROCK);
	public static final Block LIMESTONE_STONEBRICK = new BlockNewRocks("limestone_stonebrick", Material.ROCK);
	public static final Block MARBLE_STONEBRICK = new BlockNewRocks("marble_stonebrick", Material.ROCK);
	public static final Block MIGMATITE_STONEBRICK = new BlockNewRocks("migmatite_stonebrick", Material.ROCK);
	public static final Block PUMICE_STONEBRICK = new BlockNewRocks("pumice_stonebrick", Material.ROCK);
	public static final Block RHYOLITE_STONEBRICK = new BlockNewRocks("rhyolite_stonebrick", Material.ROCK);
