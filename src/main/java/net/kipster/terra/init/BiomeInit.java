...
public static Map<Integer, List<Integer>> subBiomesMap;
	...
	private static Biome initBiome(Biome biome, String name, int weight, boolean disabled, BiomeType biomeType, Type... types){
		...
		BiomeManager.addVillageBiome(BiomeInit.BLUE_MUSHROOM_PLAINS, true);
		BiomeManager.addVillageBiome(BiomeInit.BLUE_TAIGA, true);
		BiomeManager.addVillageBiome(BiomeInit.COLD_BIRCH_FOREST, true);
		BiomeManager.addVillageBiome(BiomeInit.COLD_DESERT, true);
		BiomeManager.addVillageBiome(BiomeInit.COLD_FOREST, true);
		BiomeManager.addVillageBiome(BiomeInit.COLD_MEGA_SPRUCE_TAIGA, true);
		BiomeManager.addVillageBiome(BiomeInit.COLD_MEGA_TAIGA, true);
		BiomeManager.addVillageBiome(BiomeInit.COLD_ROOFED_FOREST, true);
		...
		BiomeManager.addVillageBiome(BiomeInit.GLACIER, true);
		...
		BiomeManager.addVillageBiome(BiomeInit.SAHEL, true);
